...
const mainHTML = require('./Develop/main.HTML');

// Cards
const managerCard = require('./Develop/manager.html');
const internCard = require('./Develop/intern.html');
const engineerCard = require('./Develop/engineer.html');
